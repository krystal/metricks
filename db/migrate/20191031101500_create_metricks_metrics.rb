class CreateMetricksMetrics < ActiveRecord::Migration[5.2]
  def change
    create_table 'metrics' do |t|
      ...
      t.index %i[type association_4 time], name: 'on_assoc_4'
      t.index %i[type association_5 time], name: 'on_assoc_5'
      t.index %i[type association_1 association_2 time], name: 'on_assoc_1_and_2'
      t.index %i[type association_1 association_2 association_3 time], name: 'on_assoc_1_and_2_and_3'
      t.index %i[type association_1 association_2 association_3 association_4 association_5 time], name: 'on_all_assocs'
    end
  end
end
